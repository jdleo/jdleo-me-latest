                ...
                <div className='container-responsive'>
                    ...
                    <section className='text-center max-w-5xl mx-auto mb-8'>
                        ...
                        <div className={`mb-12 animate-reveal ${isLoaded ? '' : 'opacity-0'}`}>
                            <h1 className='text-display gradient-text mb-6'>{strings.NAME}</h1>
                            <p className='text-h3 opacity-80 mb-4'>Senior Software Engineer</p>
                        </div>
                        ...
                        >
                            {/* Main Subtitle */}
                            <p className='text-body leading-relaxed max-w-4xl mx-auto mb-6'>{strings.SUBTITLE}</p>
                            ...
                            <div className='border-t border-white border-opacity-20 pt-4'>
                                <div className='flex items-center justify-center gap-3 mb-4'>
                                    ...
                                    <span className='text-small font-medium gradient-text-accent'>Always open to</span>
                                </div>
